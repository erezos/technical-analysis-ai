...
class _CopyScreenState extends State<CopyScreen> {
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onPageStarted: (String url) {
            ...
            print('📊 [ANALYTICS] Copy widget loading: $url');
          ...
          onPageFinished: (String url) {
            ...
            print('📊 [ANALYTICS] Copy widget loaded: $url');
            FirebaseAnalytics.instance.logEvent(
          ...
          onNavigationRequest: (NavigationRequest request) {
            ...
            if (url.startsWith('market://') || 
              ...
              print('📊 [ANALYTICS] Copy widget app redirect: $url');
              FirebaseAnalytics.instance.logEvent(
  ...
  Future<void> _launchExternalUrl(String url) async {
    try {
      ...
      try {
        ...
        print('📊 [ANALYTICS] Copy widget external launch success: $targetUrl');
        FirebaseAnalytics.instance.logEvent(
        ...
        print('📊 [ANALYTICS] Direct launch failed, trying alternative method: $launchError');
        // Fallback: try with platformDefault mode
        try {
          await launchUrl(uri, mode: LaunchMode.platformDefault);
          print('📊 [ANALYTICS] Copy widget external launch success (fallback): $targetUrl');
          FirebaseAnalytics.instance.logEvent(
            name: 'copy_widget_external_launch_success',
            parameters: {
              'original_url': url,
          ...
          print('📊 [ANALYTICS] All launch methods failed: $fallbackError');
          throw Exception('Cannot launch URL: $targetUrl - $fallbackError');
        }
      }
    } catch (e) {
      // Log failed external launch
      print('📊 [ANALYTICS] Copy widget external launch failed: $url - Error: $e');
      FirebaseAnalytics.instance.logEvent(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Unable to open external link'),
  ...
  void _logPageView() {
    print('📊 [ANALYTICS] Copy screen view logged');
    FirebaseAnalytics.instance.logEvent(
  ...
  void _openZuluTradeWithReferral() {
    ...
    final referralUrl = 'https://www.zulutrade.com/?ref=2915819&utm_source=2915819&utm_medium=affiliate&utm_campaign=widget_click';
    print('📊 [ANALYTICS] Attempting to open ZuluTrade with referral URL: $referralUrl');
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    shadows: [
                      Shadow(
                        blurRadius: 16,
                        color: Color(0xFF00F0C8).withOpacity(0.7),
                        offset: Offset(0, 0),
                      ),
                    ],
                  ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                print('📊 [ANALYTICS] Copy widget clicked - opening ZuluTrade with referral');
